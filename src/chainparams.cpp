...
{
    const char* pszTimestamp = "Judge orders Stormy Daniels to reimburse Trump's legal fees";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 15000000;
        ...
        genesis = CreateGenesisBlock(1544610144, 529278, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("2a49c4a43f60fac45621e04009d69bbefd924d8f6d37493e69be44cd791903e6"));
        assert(genesis.hashMerkleRoot == uint256S("56e5d1aceaa82279a6a223a9671bf6015bc350f5d78e6e5935666e20eca67891"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("142.93.48.145", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.biggcoincointools.com", true);
        vSeeds.emplace_back("seed-b.biggcoincoin.loshan.co.uk", true);
