...
#if defined(NDEBUG)
# error "biggcoincoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "biggcoincoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BIGG additional fees, %d delta bytes\n",
