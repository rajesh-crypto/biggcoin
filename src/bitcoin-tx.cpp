...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s biggcoincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  biggcoincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded biggcoincoin transaction") + "\n" +
              "  biggcoincoin-tx [options] -create [commands]   " + _("Create hex-encoded biggcoincoin transaction") + "\n" +
              "\n";
