...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/biggcoincoin-project/biggcoincoin>";
    const std::string URL_WEBSITE = "<https://biggcoincoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("biggcoincoin version %s\n", FormatFullVersion());
}
